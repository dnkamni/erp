...
/**	* Client Controller class	* PHP versions 5.3.5	* @date 28-Dec-2011	* @Purpose:This controller handles all the functionalities regarding clients management.	* @filesource	* @author  Netset Solutions	* @revision	* @version 1.3.12**/App::import('Sanitize');class ClientsController extends AppController{    var $name       	=  "Clients";    /**	* Specifies helpers classes used in the view pages	* @access public    */    var $helpers    	=  array('Html', 'Form', 'Javascript', 'Session');
    ...
    * @Date: 28-Dec-2011    * @Method : admin_index    * @Purpose: This is the default function of the administrator section for users    * @Param: none    * @Return: none     **/
    ...
    function admin_list(){
	$this->set('title_for_layout','Client Listing');	$this->set("pageTitle","Client Listing");    $this->set("search1", "");	$this->set("search2", "");	$criteria = "1";
    ...
    /**    * @Date: 28-Dec-2011    * @Method : admin_add    * @Purpose: This function is to add/edit clients from admin section.    * @Param: $id    * @Return: none     * @Return: none     **/
