  ...
  /**
   ...
   function getProductFeatures($feature_id) {
	...
	return $ques;
		...
		//Retrieve news to show on frontend
    function getNews(){
	App::import('Model','News');
	$this->News= new News;
	$result= $this->News->find('all',array(
	//'conditions'=>array('published'=>'1'),
	'fields'=>array('id','title','description','image'),
	'order'=>'id desc',
	));
	return $result;
	}
	
	//Retrieve testimonial to show on frontend
    function gettestimonial(){
	App::import('Model','Testimonial');
	$this->Testimonial= new Testimonial;
	$result= $this->Testimonial->find('all',array(
	//'conditions'=>array('published'=>'1'),
	'fields'=>array('id','author','description'),
	'order'=>'id desc',
	'limit'=>'5'
	));
	return $result;
	...
	$data=array(
		...
		"Feedback / Grievance"=>"Feedback / Grievance",
