...
<tr><td align="center"><h4 > Testimonial(s) Report </h4></td></tr>
...
<td align="center" style="color:black ; font-weight:bold;">Author</td>
...
<td align="left" style="color:black ; font-weight:bold;">'. $val['Testimonial']['author'].'</td>
<td align="left" style="color:black ; font-weight:bold;">'. nl2br($val['Testimonial']['description']).'</td>
<td align="left" style="color:black ; font-weight:bold;">'. $val['Testimonial']['type'].'</td>
<td align="left" style="color:black ; font-weight:bold;">'. $val['Testimonial']['keyword'].'</td>
</tr>' ;
}
...
$pdf->Output('TestimonialReport.pdf', 'D');
?>