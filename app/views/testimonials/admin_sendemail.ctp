...
<script type="text/javascript" language="javascript">
  ...
  <!--  start content-table-inner -->
	...
	<?php echo $form->create('Testimonial',array('action'=>'sendemail','method'=>'POST','onsubmit' => '',"class"=>"login")); ?>
	...
	<table border="0" cellpadding="0" cellspacing="0"  id="id-form"  style="font-size:12px">
		...
		<tr>
			...
			<td><?php
				 echo nl2br($crData['Testimonial']['author']);
            ?></td>
			<td></td>
		</tr>	
		<tr>
			...
			<td><?php
				 echo nl2br($crData['Testimonial']['description']);
            ?>
      </td>
			<td></td>
		</tr>	
		<tr>
			...
			<td><?php
				 echo nl2br($crData['Testimonial']['keyword']);
            ?>
      </td>
			<td></td>
		</tr>		
    ...
    <tr>
		...
		<tr>
			<th>&nbsp;</th>
			<td valign="top">
			<?php echo $form->hidden('id', array("value"=>$crData['Testimonial']['id'])); echo $form->submit('Save',array('class'=>"form-submit",'div'=>false))."&nbsp;&nbsp;&nbsp;";?>
			</td>
			<td></td>
		</tr>
	</table>
