...
<br>
<p align="right" style="padding-right:20px;"><a href=" http://www.facebook.com/netsetsoftware" target="_blank"><img src="<?php echo BASE_URL."images/fb.jpg"?>" width="15" height="15" hspace="4"></a>
<a href=" https://twitter.com/NetSetSoftware" target="_blank"><img src="<?php echo BASE_URL."images/twitt.jpg"?>" width="15" height="15" hspace="4"></a>
<a href="http://www.youtube.com/netsetsol" target="_blank"><img src="<?php echo BASE_URL."images/youtube.png"?>" width="15" height="15" hspace="4"></a>
<a href="http://www.linkedin.com/company/netset-software-pvt-ltd" target="_blank"><img src="<?php echo BASE_URL."images/linkedin.png"?>" width="15" height="15" hspace="4"></a>
</p>
</div>
<p align="right"></p>
<div class="v1">
...
?>
<!--<p class="p8 j"><strong><?php echo $data['Testimonial']['author'] ;?></strong><br/>
<br/>
<?php echo substr(strip_tags($data['Testimonial']['description']),0,80)."...";?></p>-->
<p class="p10 x6"><b class="c6"><?php echo$data['Testimonial']['author']; ?></b><br/>
		<?php echo substr(strip_tags($data['Testimonial']['description']),0,85)."...";?>
	</p>
<?php } ?>
<!--<div class="fl w5">
