...
<?php echo $javascript->link(array('ui.core','ui.checkbox','jquery','jquery.bind','common','custom_jquery','listing','functions')); ?>
...
<?php// echo $javascript->link(array('jquery.selectbox-0.5','jquery.selectbox-0.5_style_2','jquery.selectbox-0.5_style_2','jquery.filestyle','custom_jquery','jquery.tooltip','jquery.dimensions','date','jquery.datePicker','jquery.pngFix.pack')); ?>
...
<div id="page-top">
	...
	<div id="logo">
	<?php echo $html->link(
			$html->image(BASE_URL."images/shared/logo_inner.png",array("alt" => SITE_NAME)),
...
<div class="nav-outer"> 
		...
		<ul class="select"><li><a href="<?php echo BASE_URL.'admin/users/list';?>"><b>User</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
				<li><a href="<?php echo BASE_URL.'admin/users/add';?>">User Add</a></li>
				<li><a href="<?php echo BASE_URL.'admin/users/list';?>">User List</a></li>
				<li><a href="<?php echo BASE_URL.'admin/users/dashboard';?>">User Dashboard</a></li>
			</ul>
		</div>
...
<div id="content">
<?php if (!empty($user)) { ?>		
<div id="page-heading"><h1>My Account: <?php echo ucwords($user['1']); ?></h1></div>
<?php }?>
